...
try:
    ...
    try:
        ...
        f.logOperazioni("\t\t\tErrore PDF: " + str(errorePdf) + "\n")
        sys.exit()
    ...
    try:
        ...
        f.logOperazioni("\t\t\tErrore Excel: " + erroreExcel + "\n")
    ...
    try:
        ...
        f.logOperazioni("\t\t\tErrore lettura celle Excel: " + erroreCellaExcel + "\n")
    ...
    print("Procedo con l'unione dei cedolini che fanno riferimento allo stesso dipendente")
